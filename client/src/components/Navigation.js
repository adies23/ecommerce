...
function Navigation() {
  ...
  function handleToggleNotifications(){
    ...
    setBellPos(position);
    console.log("notificationRef.current.style.display: " + notificationRef.current.style.display);
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            {!user && (<LinkContainer to="/login"><Nav.Link href="/login">Login</Nav.Link></LinkContainer>)}
            {user && !user.isAdmin && (
            ...
            {user && (
              <>
                <Nav.Link style={{position: "relative"}} onClick={handleToggleNotifications}>
                  <i className="fa fa-bell" ref={bellRef} data-count={unreadNotifications || null}></i>
                </Nav.Link>
