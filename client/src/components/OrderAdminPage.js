...
import { useUpdateStatusOrderMutation } from '../services/appApi';
            ...
            <tbody>
                {orders.map((order) => (
                    <tr>
                        ...
                        <td style={{cursor: "pointer"}} onClick={() => showOrder(order.products)}>
                            <span>View order <i className="fa fa-eye"></i></span>
                        </td>
                    </tr>
                ))}
            </tbody>
