...
const stripePromise = loadStripe("pk_test_51Lx4KrDmBcBYTCkGUwS7x28lCwqT1KRRcIhuluhuZshkCeDNLobRSChUzM3nIe4LPN0AiXcLQd1Y1Qr3BJD3GnOd00vftME6Ie");
...
function CartPage() {
    ...
    function handleDecrease(product){
        ...
        if(quantity <= 0) return alert("Can't procees");
